...
def angle_axis_to_exp_map(angle, axis):
    ...
    # compute exponential map from axis-angleisaac_utils/isaac_utils
...
@torch.jit.script
def quat_to_rotation_matrix(quaternions: torch.Tensor, w_last: bool) -> torch.Tensor:
    """
...
@torch.jit.script
def my_quaternion_to_matrix(quaternions: torch.Tensor, w_last: bool) -> torch.Tensor:
    """
    Convert rotations given as quaternions to rotation matrices.
